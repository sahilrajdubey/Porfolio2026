...
export default function ProjectCard({
  ...
  return (
    <div className="relative z-10 w-full max-w-7xl mt-16 sm:mt-24 md:mt-32 first:mt-0">
      ...
      <div className="relative p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="col-span-1 md:col-span-2 lg:col-span-3 flex justify-center max-w-6xl mx-auto">
            <div className="w-full sm:w-5/6 md:w-4/5 lg:w-3/5 xl:w-2/3 relative p-2 sm:p-3 bg-white/50 backdrop-blur-sm border border-green-900/100 rounded-xl sm:rounded-2xl shadow-xl">
              <video
                src={videoUrl}
                className="w-full h-auto object-cover rounded-lg sm:rounded-xl shadow-inner"
                autoPlay
                loop
                muted
                playsInline
        ...
        <div className="relative p-2 sm:p-4 md:p-8 lg:p-10">
        ...
        <div className="text-center mb-1">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-[family-name:var(--font-playfair)] font-medium text-black mb-3 sm:mb-4 tracking-widest uppercase px-4">
            {title}
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed text-sm sm:text-base md:text-base font-light px-4">
            {description}
          </p>
          ...
          <div className="flex justify-center mt-8 sm:mt-10 md:mt-12 pb-6 sm:pb-8">
            ...
            >
              <SiGithub className="w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform duration-300" />
              <span className="font-[family-name:var(--font-playfair)] font-medium text-base sm:text-lg border-b border-transparent group-hover:border-black transition-all duration-300">
                View Repository
              </span>
            </a>
          </div>
          ...
          {/* Wavy Arrow */}
          {showArrow && (
            <div className="absolute -bottom-16 sm:-bottom-20 md:-bottom-24 left-1/2 -translate-x-1/2 w-6 sm:w-8 text-black animate-bounce">
